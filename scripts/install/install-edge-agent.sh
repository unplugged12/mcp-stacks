...
if [ -z "$DOCKER_COMMAND" ]; then
    ...
    echo -e "${NC}1. Log into Portainer at https://portainer-server.lan:9444${NC}"
    ...
    echo -e "${NC}   - Portainer server URL: https://portainer-server.lan:9444${NC}"
...
echo -e "${NC}• Connect to https://portainer-server.lan:9444 via tunnel port 8000${NC}"
