...
if ([string]::IsNullOrWhiteSpace($DockerCommand)) {
    ...
    Write-Host "1. Log into Portainer at https://portainer-server.lan:9444" -ForegroundColor White
    ...
    Write-Host "   - Portainer server URL: https://portainer-server.lan:9444" -ForegroundColor White
...
Write-Host "• Connect to https://portainer-server.lan:9444 via tunnel port 8000" -ForegroundColor White
